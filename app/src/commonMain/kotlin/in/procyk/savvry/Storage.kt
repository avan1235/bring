...
import `in`.procyk.savvry.ui.defaultUseBottomNavigation
import `in`.procyk.savvry.ui.defaultUseLiquidGlassNavigation
...
val LocalUseHaptics: ProvidableCompositionLocal<Boolean> =
    staticCompositionLocalOf { SavvryStore.Default.useHaptics }
...
@Composable
internal expect inline fun <reified T : @Serializable Any> savvryCodec(): Codec<T>
