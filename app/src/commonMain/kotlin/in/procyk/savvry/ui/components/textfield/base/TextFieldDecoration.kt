package `in`.procyk.savvry.ui.components.textfield.base
...
internal fun CommonDecorationBox(
    ...
    TextFieldTransitionScope.Transition(
        ...
        val decoratedLabel: @Composable (() -> Unit)? =
            label?.let {
                @Composable {
                    Decoration(labelColor, SavvryAppTheme.typography.label1, it)
                }
            }
                ...
                @Composable { modifier ->
                    Box(modifier.alpha(placeholderAlphaProgress)) {
                        Decoration(
                            ...
                            typography = SavvryAppTheme.typography.input,
                            content = placeholder,
                        )
                    }
                }
            ...
            supportingText?.let {
                @Composable {
                    Decoration(
                        ...
                        typography = SavvryAppTheme.typography.body2,
                        content = it
                    )
                }
            }
