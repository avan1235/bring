package `in`.procyk.savvry.ui.components.progressindicators
...
internal fun LinearProgressIndicator(
    ...
    val animatedProgress by animateFloatAsState(targetValue = coercedProgress)
    Canvas(
        modifier
        ...
        drawLinearIndicator(0f, animatedProgress, color, strokeWidth, strokeCap)
    }
}
...
object LinearProgressIndicatorDefaults {
    ...
    val TrackColor: Color
        @Composable get() = SavvryAppTheme.colors.transparent
