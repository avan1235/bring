...
internal object TextFieldDefaults {
    ...
    fun colors(): TextFieldColors {
        return TextFieldColors(
            ...
            focusedContainerColor = BringAppTheme.colors.surface,
            unfocusedContainerColor = BringAppTheme.colors.surface,
            disabledContainerColor = BringAppTheme.colors.disabled,
            errorContainerColor = BringAppTheme.colors.surface,
            cursorColor = BringAppTheme.colors.primary,
            errorCursorColor = BringAppTheme.colors.error,
            textSelectionColors = LocalTextSelectionColors.current,
            focusedOutlineColor = BringAppTheme.colors.transparent,
            unfocusedOutlineColor = BringAppTheme.colors.transparent,
            disabledOutlineColor = BringAppTheme.colors.transparent,
