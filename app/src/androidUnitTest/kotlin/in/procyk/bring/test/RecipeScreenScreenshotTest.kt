...
import `in`.procyk.bring.CookingRecipe
...
internal class RecipeScreenScreenshotTest : BringAppCreateScreenshotTest() {

    @Test
    fun `recipes screen`() = screenshotBringApp(
        modifier = Modifier
    ...
    @Test
    fun `recipe screen`() = screenshotBringApp(
        modifier = Modifier
            .scale(MidScale),
        config = {
            copy(
