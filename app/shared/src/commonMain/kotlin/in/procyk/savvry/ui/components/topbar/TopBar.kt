package `in`.procyk.savvry.ui.components.topbar
...
import `in`.procyk.savvry.ui.components.topbar.TopBarDefaults.TopBarHeight
import `in`.procyk.savvry.ui.components.topbar.TopBarState.Companion.Saver
...
object TopBarDefaults {
    ...
    @Composable
    fun topBarColors(
        containerColor: Color = SavvryAppTheme.colors.background,
        scrolledContainerColor: Color = SavvryAppTheme.colors.background,
    ): TopBarColors =
        TopBarColors(
            containerColor,
...
@Composable
internal fun rememberTopBarState(
