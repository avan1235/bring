package `in`.procyk.savvry.ui.components.card
...
internal object CardDefaults {
    ...
    fun cardColors(
        ...
        contentColor: Color = SavvryAppTheme.colors.onSurface,
        disabledContainerColor: Color =
            SavvryAppTheme.colors.disabled,
        disabledContentColor: Color = SavvryAppTheme.colors.onDisabled,
    ): CardColors =
        CardColors(
    ...
    fun elevatedCardColors(
        ...
        contentColor: Color = SavvryAppTheme.colors.onBackground,
        disabledContainerColor: Color =
            SavvryAppTheme.colors.disabled,
        disabledContentColor: Color = SavvryAppTheme.colors.onDisabled,
    ): CardColors =
