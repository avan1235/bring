...
import `in`.procyk.savvry.ui.components.ChipDefaults.ChipIconHorizontalPadding
import `in`.procyk.savvry.ui.components.ChipDefaults.ChipIconSize
import `in`.procyk.savvry.ui.components.ChipDefaults.ChipRectShape
...
internal object ChipDefaults {
    ...
    fun primaryFilled(shape: Shape) =
        ChipStyle(
            colors =
                ChipColors(
                    containerColor = SavvryAppTheme.colors.surface,
                    contentColor = SavvryAppTheme.colors.onSurface,
                    selectedContainerColor = SavvryAppTheme.colors.primary,
                    selectedContentColor = SavvryAppTheme.colors.onPrimary,
        ...
        ChipStyle(
            colors =
                ChipColors(
                    ...
                    outlineColor = SavvryAppTheme.colors.primary,
                    selectedContainerColor = SavvryAppTheme.colors.primary,
                    selectedOutlineColor = SavvryAppTheme.colors.primary,
                    selectedContentColor = SavvryAppTheme.colors.onPrimary,
