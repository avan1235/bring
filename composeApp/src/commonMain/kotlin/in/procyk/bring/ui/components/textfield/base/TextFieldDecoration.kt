package `in`.procyk.bring.ui.components.textfield.base
...
internal fun CommonDecorationBox(
    ...
    TextFieldTransitionScope.Transition(
        ...
        val decoratedLabel: @Composable (() -> Unit)? =
            label?.let {
                @Composable {
                    Decoration(labelColor, BringAppTheme.typography.label1, it)
                }
            }
                ...
                @Composable { modifier ->
                    Box(modifier.alpha(placeholderAlphaProgress)) {
                        Decoration(
                            ...
                            typography = BringAppTheme.typography.input,
                            content = placeholder,
                        )
                    }
                }
            ...
            supportingText?.let {
                @Composable {
                    Decoration(
                        ...
                        typography = BringAppTheme.typography.body2,
                        content = it
                    )
                }
            }
