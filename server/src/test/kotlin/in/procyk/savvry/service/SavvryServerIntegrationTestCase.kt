...
internal abstract class SavvryServerIntegrationTestCase {
    ...
    private val SERVER_SERVICE_NAME: String = "savvry-dev-server"
    ...
    companion object {
        private const val SERVER_IMAGE_TAG = "savvry-dev-server:test"
